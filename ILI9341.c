...
Adopted to 16bit:			Labude 27/02/2020
...
void ILI9341_printTextR(char text[], int16_t x, int16_t y, uint16_t color, uint16_t bg, uint8_t size, uint16_t length)
{
	int16_t offset;
	offset = size*6;
	for(uint16_t i = length; i<40 && text[i]!=NULL; i--)
	{
		ILI9341_drawChar(x-(offset*i), y, text[i],color,bg,size);
	}
}
